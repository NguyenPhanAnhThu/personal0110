...
<div class="row-fluid sortable">
				<div class="box span12">
					...
					<div class="box-content">
						<form class="form-horizontal" method="post" action="{{route('add-tintuc')}}"enctype="multipart/form-data">
                            @csrf
						  <fieldset>
                          <div class="control-group">
								<label class="control-label" for="focusedInput">Tiêu đề</label>
								<div class="controls">
								  <input class="input-xlarge focused" id="focusedInput" name="tieude" type="text" placeholder="This is focused…">
								</div>
                            </div>
                            <div class="control-group">
								<label class="control-label" for="focusedInput">Tóm tắt</label>
								<div class="controls">
								  <textarea rows="4" cols="250" class="input-xlarge" name="tomtat"></textarea>
								</div>
							</div>
							...
							<div class="control-group hidden-phone">
							  ...
							  <div class="controls">
								<textarea class="cleditor" id="textarea2" rows="3" name="noidung"></textarea>
							  </div>
							</div>
							<div class="control-group">
